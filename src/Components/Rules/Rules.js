			...
			<div className="rules_main">
				...
				<p className="rules_p">Основные правила:
					<ul>
						...
						<li className="rules_li">Если у вас остались не использованные ходы, вы не сможете завершить ход, за исключением случаев, когда единственный доступный ход отправит вас на лищний круг</li>
					</ul>
				</p>
			</div>
